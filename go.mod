...
require (
	github.com/armosec/armoapi-go v0.0.607
	github.com/armosec/registryx v0.0.28
	...
	github.com/kubescape/node-agent v0.2.390
...
require (
	...
	github.com/inspektor-gadget/inspektor-gadget v0.41.0 // indirect
