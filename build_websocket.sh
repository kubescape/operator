...
docker build --no-cache -t dreg.eust0.cyberarmorsoft.com:443/k8s-ca-websocket-test:v0 .

rm -rf k8s-ca-websocket

docker push dreg.eust0.cyberarmorsoft.com:443/k8s-ca-websocket-test:v0
